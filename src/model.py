...
class GraphFormer(pl.LightningModule):
    def __init__(
        ...
        '''NEW=============================================='''
        self.gelu = nn.GELU()
        self.atom_edge_encoder = nn.Embedding(118*4+32+(2)+1+20+offset +51, hidden_dim, padding_idx=0) # atom*chiral +bond+start+end+0+gapnumber+[nh] offset +50+1split
    ...
    def test_step(self, batched_data, batch_idx): #split
        ...
        # topk actually means prick k not topk 
        topk = 50
        y_true = batched_data.y_gt.view(-1)
    ...
    def test_epoch_end(self, outputs):
        ...
        out_dic = {}
        i = 0
        path ="/da1/G2GT/src/results/uspto-full-distill-weaklabel/"
