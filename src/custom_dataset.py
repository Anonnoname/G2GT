...
class UsptoDataset(InMemoryDataset):
    def __init__(self, root = 'data/uspto-full-distilled-weaklabel', smiles2graph = smiles2graph, transform=None, pre_transform = None, smiles2graph_wrapper = smiles2graph_wrapper):
        '''
